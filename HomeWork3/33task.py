...
dict_english_lang_scrabble = {1:'AEIOULNSTR',
      	2:'DG',
      	3:'BCMP',
      	4:'FHVWY',
      	5:'K',
...
dict_russian_lang_scrabble = {1:'АВЕИНОРСТ',
      	2:'ДКЛМПУ',
      	3:'БГЁЬЯ',
      	4:'ЙЫ',
      	5:'ЖЗХЦЧ',
...
if isEnglish(word):
    result = [key for letter in word for key, value in dict_english_lang_scrabble.items() if letter in value]
else:
	result = [key for letter in word for key, value in dict_russian_lang_scrabble.items() if letter in value]
